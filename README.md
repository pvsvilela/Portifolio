...
## Pages
- `index.html`: main portfolio with hero, about, skills, experience train cars, projects placeholders, education, and contact.
- `design-system.html`: token reference, typography, layout rules, and component previews for developer handoff.

## Getting started
Open `index.html` in a browser. Theme selection persists via `localStorage` and respects OS preferences.
